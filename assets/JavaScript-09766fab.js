import{S as i}from"./StudyMenu-f91430e9.js";import{m as c}from"./marked.esm-fcaba525.js";import{H as l}from"./index-0153fe02.js";import{_ as u,r as p,a as d,p as m,e as f,b as h,c as y,d as r,f as g}from"./index-333d309d.js";import"./_commonjsHelpers-042e6b4d.js";const _=""+new URL("prototype-1edecc9d.png",import.meta.url).href,S=`
## 原型和原型链
...
getA(); // 10
\`\`\`
`,b=""+new URL("domSize1-29a5a82e.png",import.meta.url).href,O=""+new URL("domSize2-64795dc2.png",import.meta.url).href,j=""+new URL("domSize3-fb8868bb.png",import.meta.url).href,k=""+new URL("domSize4-mouse-7c539811.jpeg",import.meta.url).href,N=`
## DOM的尺寸和位置
![](${b})
...
- screen: 鼠标相对屏幕的坐标
`,x=""+new URL("eventLoop-44627701.png",import.meta.url).href,L=`
## 事件循环
...
`,w=""+new URL("actionScope-26c3d1da.png",import.meta.url).href,V=`
## 作用域链
...
\`\`\`
![](${w})
`,$=""+new URL("Promise1-a8212b78.png",import.meta.url).href,z=""+new URL("Promise2-da0f3668.png",import.meta.url).href,U=`
## Promise
### Promise A+规范
...
`;const F={prototype:S,thisFor:v,domSize:N,eventLoop:L,dataOperation:P,context:R,actionScope:V,promise:U,iterator:A,generator:M,dataStorage:C},I={components:{StudyMenu:i},setup(){const o=p("prototype"),t=d([{key:"prototype",title:"原型和原型链"},{key:"thisFor",title:"this指向"},{key:"domSize",title:"尺寸和位置"},{key:"eventLoop",title:"事件循环"},{key:"dataOperation",title:"类型转换"},{key:"context",title:"执行上下文"},{key:"actionScope",title:"作用域链"},{key:"promise",title:"Promise"},{key:"iterator",title:"迭代器"},{key:"generator",title:"生成器"},{key:"dataStorage",title:"数据存储"}]),n=m(()=>c(F[o.value],{headerIds:!1,mangle:!1,highlight:function(e){return l.highlightAuto(e).value}}));return{menu:t,curSelected:o,mdContent:n}}},J={class:"page study-page"},H={class:"content"},B=["innerHTML"];function G(o,t,n,e,T,D){const s=f("StudyMenu");return h(),y("div",J,[r("div",H,[r("div",{class:"markdown-body",innerHTML:e.mdContent},null,8,B)]),g(s,{menu:e.menu,curSelected:e.curSelected,"onUpdate:curSelected":t[0]||(t[0]=a=>e.curSelected=a)},null,8,["menu","curSelected"])])}const X=u(I,[["render",G],["__scopeId","data-v-19f57f35"]]);export{X as default};
